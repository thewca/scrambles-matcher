    ...
    <Grid container justify="center">
      <Grid item xs={12} md={8} lg={6} xl={6} style={{ padding: 16 }}>
        <Paper style={{ padding: 16 }}>
          ...
          <ul>
            <li>import an existing WCIF file</li>
            <li>
              import a a results spreadsheet (created by cubecomps or
              cubingchina) that will be converted to a WCIF.
            </li>
            <li>
              import a WCIF from the WCA website.
              <br />
              <Typography
                component="span"
                color="error"
              ...
              saves the results in the WCIF on the WCA website (eg: WCA Live).
            </li>
          </ul>
          <Grid
            container
          ...
          >
            ...
            <Typography variant="h6" className={classes.h6}>
              Alternatively, select a competition you manage on the WCA website:
            </Typography>
            {loading ? (
              <Loading />
            ) : (
